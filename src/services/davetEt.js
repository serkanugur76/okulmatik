 ...
 */
export async function davetEt({ email, rol, kurumId, googleAltyapisi, ad = '', modulIzinler = {}, sinifAtamalari = [], sinifIdler = [], erisimKurumIdler = [], parentKurumIdler = [], branslar = [] }) {
  // Her durumda yetkili listesine ekle
  await setDoc(doc(db, 'yetkiliKullanicilar', email), {
    email, rol, kurumId, googleAltyapisi: !!googleAltyapisi, ad,
    modulIzinler, sinifAtamalari, sinifIdler, erisimKurumIdler, parentKurumIdler, branslar,
